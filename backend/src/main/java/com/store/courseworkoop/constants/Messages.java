package com.store.courseworkoop.constants;

public class Messages {
    // User-related messages
    public static final String USER_NOT_FOUND = "User not found";
    public static final String USER_ALREADY_EXISTS = "User already exists";
    public static final String USER_GET_SUCCESSFULLY = "User retrieved successfully";
    ...
    public static final String USER_VERIFIED_SUCCESS = "User verified successfully";
